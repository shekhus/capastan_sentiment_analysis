...
MLFLOW_TRACKING_URI = "https://dagshub.com/shekhus/capastan_sentiment_analysis.mlflow"
...
def train_and_log_model(X_train, X_test, y_train, y_test, vectorizer):
    ...
    param_grid = {
        "C": [0.1, 1, 10], 
# 0.1	Strong regularization	Small datasets, noisy text
# 1	   Balanced	 Default baseline
# 10   Weak regularization	Large, clean datasets
